        ...
        function del(i,j) {
            if(i>=0){
                ...
                setTimeout(function () {
                    ...
                    document.getElementById(im2).removeAttribute('src');
        ...
        function count_num(i) {
            if(i<fnum){
                ...
                if(i< (fnum + lnum)){
                    ...
                    //sum += 1;
                    //document.getElementById(im).removeAttribute('src');
                    document.getElementById(num).innerText = i-fnum+1;
                    setTimeout(function () {
                        count_num(i+1);
                        setTimeout(function () {
                            removeNumber();
                ...
                <div class="col-sm-12" style="float: left; margin: 0; padding: 0;">
                    ...
                    <table class="table-borderless">
                        <tr>
                            ...
                            <td><p class="card-title" id="summation" style="font-size: 50px; margin-right: 20px; float: left;">2</p></td>
                        </tr>
                        <tr>
                            <?php
                            for($i=0;$i<5;$i++){
